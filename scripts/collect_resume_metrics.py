...
from educoder.metrics import collect_resume_metrics, render_resume_metrics_markdown


def build_arg_parser():
    parser = argparse.ArgumentParser(description="Collect educoder resume metrics from benchmark and run artifacts.")
    parser.add_argument("--benchmark-artifact", required=True, help="Path to benchmark artifact JSON.")
    parser.add_argument("--runs-root", required=True, help="Path to .educoder/runs root.")
