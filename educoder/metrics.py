...
DEFAULT_CORE_REPORT_PATH = Path("docs/metrics/educoder-benchmark-core-report.md")
...
def _run_recovery_task_variant(task, variant):
    with tempfile.TemporaryDirectory(prefix="educoder-recovery-ablation-") as temp_dir:
        workspace_root = Path(temp_dir)
        (workspace_root / "README.md").write_text("demo\n", encoding="utf-8")
...
def write_benchmark_core_report(
    ...
    lines = [
        "# EduCoder Benchmark Core Report",
        "",
